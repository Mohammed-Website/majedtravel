        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/majedtravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض المالديف',
        image_1: ['عروض-شركة-ماجد/عروض-المالديف/عرض-المالديف-1.jpg', '5 أيام في فندق Hard Rock Maldives'],
    },

    {
        title: 'عروض اندونيسيا',
        image_1: ['عروض-شركة-ماجد/عروض-اندونيسيا/عرض-اندونيسيا-1.jpg', 'جاكرتا & بونشاك & بوقور & بالي'],
        image_2: ['عروض-شركة-ماجد/عروض-اندونيسيا/عرض-اندونيسيا-2.jpg', 'بالي & جاكرتا & بونشاك'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-ماجد/عروض-تايلاند/عرض-تايلاند-1.jpg', 'بانكوك 3 ليالي & فوكيت 5 ليالي'],
    },

    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-ماجد/عروض-لندن/عرض-لندن-1.jpg', 'عرض لندن - 8 أيام'],
        image_2: ['عروض-شركة-ماجد/عروض-لندن/عرض-لندن-2.jpg', 'عرض لندن - 8 أيام'],
        image_3: ['عروض-شركة-ماجد/عروض-لندن/عرض-لندن-3.jpg', 'عرض لندن - 9 أيام'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-ماجد/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'سيلانجور سانوي & بينانج & لانجكاوي & كوالالمبور'],
        image_2: ['عروض-شركة-ماجد/عروض-ماليزيا/عرض-ماليزيا-2.jpg', 'سيلانجور سانوي & بينانج & لانجكاوي & كوالالمبور'],
        image_3: ['عروض-شركة-ماجد/عروض-ماليزيا/عرض-ماليزيا-3.jpg', 'سيلانجور سانوي & جنتنج & لنكاوي & كوالالمبور'],
    },

    {
        title: 'عروض اسبانيا',
        image_1: ['عروض-شركة-ماجد/عروض-اسبانيا/عرض-اسبانيا-1.jpg', 'برشلونة & ملقا & ماربيا'],
    },

    {
        title: 'عروض اليونان',
        image_1: ['عروض-شركة-ماجد/عروض-اليونان/عرض-اليونان-1.jpg', 'أثينا & سينتوريني & ميكانوس'],
    },

    {
        title: 'عروض ايطاليا',
        image_1: ['عروض-شركة-ماجد/عروض-ايطاليا/عرض-ايطاليا-1.jpg', 'ميلان & فينيسيا & فلورنس & روما'],
    },

    {
        title: 'عروض اوروبا',
        image_1: ['عروض-شركة-ماجد/عروض-اوروبا/عرض-اوروبا-1.jpg', 'باريس & أمستردام & ديزني لاند'],
    },
];
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة ماجد على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة ماجد على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة ماجد على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة ماجد للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة ماجد للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة ماجد`;
            img.title = `مكتب سياحي - شركة ماجد`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966555328646";
